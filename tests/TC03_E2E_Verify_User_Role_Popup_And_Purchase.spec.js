 ...
 test(`E2E User Role Popup And Purchase_TestData ${index+1}`, async({page}) =>{
    ...
    await loginPage.loginAsUser(data.valid_username, data.valid_password, data.role);
    ...
    await purchasePage.purchase().catch().finally();
